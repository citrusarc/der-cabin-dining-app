...
export default function ChildHomePage() {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 bg-black">
      ...
      <div
        ref={categoryRef}
        className={`sticky top-0 z-50 flex gap-4 text-md sm:text-lg font-medium overflow-x-auto whitespace-nowrap bg-black/50 backdrop-blur-sm transition-all duration-300 scrollbar-thin scrollbar-thumb-transparent scrollbar-track-transparent ${
          isSticky ? "py-4" : "py-2"
        }`}
      >
